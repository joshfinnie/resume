...
%----------------------------------------------------------------------------------------------------------------------
\begin{document}
\name{\Huge Josh Finnie \large Software Engineer}\vspace{10mm}
\begin{resume}
    ...
    \begin{multicols}{2}
        ...
        \begin{list2}
            \item HTML, CSS (Sass and Less), Jade, JSON
        \end{list2}
        \columnbreak
        \textbf{Databases}
        \begin{list2}
            \item PostgreSQL, Redis, MongoDB, MySQL, ArcSDE
        \end{list2}
        \textbf{Other}
        \begin{list2}
    ...
    \textbf{skills:} Angular.js, Django, Docker, Amazon Web Services (EC2, ELB, S3, Route53)
    ...
    Economics (Minor in Mathematics)\vspace{90mm}
